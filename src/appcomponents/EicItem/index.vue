        ...
        <div class="eic-item border-bottom-1px _av">
                ...
                <div class="content">
                        ...
                        <div class="footer">
                                ...
                                <p class="status" :class="{success:statusClass == 'SUCCESS'}">{{status}}</p>
                        </div>
                        <img v-if="redEicIcon" class="eic_red_status" :src="require('@src/assets/images/eic_red_status.png')" alt="">
                </div>
        </div>
</template>
